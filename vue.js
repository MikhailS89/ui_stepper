...
const App = {
  data() {
    return {
      ...
      complite: false, //блокирует выбор шагов , если бользователь нажал "закончить"
      show: true,
      next: 'Вперед',
      back: 'Назад'
    }
  ...
  methods: {
    ...
    nextOfFinish() {
      ...
      if(this.activeIndex < (this.steps.length - 1)) {
        ...
        this.show = false
        this.back = 'Начать заново'
        this.complite = true
      }
    },
    setActive(idx) {
      // когда нажимаем на определенный шаг
      if(this.activeIndex !== idx && !this.complite) {
  ...
  computed: {
    ...
    lastStep() {
      return this.activeIndex === (this.steps.length - 1) ? this.next = 'Закончить' : this.next = 'Вперед'
    },
  }
}
